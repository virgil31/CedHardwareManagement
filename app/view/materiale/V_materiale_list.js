Ext.define('CL.view.materiale.V_materiale_list', {
    extend: 'Ext.panel.Panel',
    xtype: 'materiale_list',
    itemId: 'materiale_list_id',
    alias: 'widget.materiale_list',
        ...
        this_view.items = [
            {
                ...
                dockedItems: [{
                    xtype: 'pagingtoolbar',
                    store: 'S_materiale', // same store GridPanel is using
                    dock: 'bottom',
                    displayInfo: true
                }],
                ...
                listeners: {
                    itemdblclick: function( grid, record, item, index, e, eOpts ){
                        CL.app.getController("C_materiale").onEdit(item,record);
                    }
                },
                        ...
                        items: [
                            {
                                ...
                                handler: function(grid, rowIndex, colIndex) {
                                    ...
                                    CL.app.getController("C_materiale").onEdit(this.el,rec);
                                }
                            },
                            {
